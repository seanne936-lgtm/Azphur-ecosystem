...
const styles: Record<string, React.CSSProperties> = {
  page: { minHeight: '100vh', background: 'radial-gradient(circle at 88% 0%, rgba(34,211,238,.16), transparent 32rem), #f5f8f8', color: '#0f172a', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", Inter, sans-serif', padding: '24px 0 60px' },
  ...
  header: { maxWidth: 1400, margin: '0 auto', boxSizing: 'border-box', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 18, padding: '20px clamp(18px,4vw,50px)', borderBottom: '1px solid #dbe8eb', borderRadius: '0 0 24px 24px', background: 'rgba(255,255,255,.88)', backdropFilter: 'blur(16px)', boxShadow: '0 10px 30px rgba(8,145,178,.04)' },
  ...
  hero: { maxWidth: 1120, margin: '24px auto 28px', padding: 'clamp(36px,7vw,68px) clamp(20px,5vw,58px)', boxSizing: 'border-box', borderRadius: 32, border: '1px solid rgba(34,211,238,.34)', background: 'linear-gradient(150deg,#d7f7f4 0%,#eefbfa 54%,#fff 100%)', boxShadow: '0 20px 45px rgba(6,182,212,.10)' },
  ...
  directorySection: { maxWidth: 1120, margin: '0 auto 28px', padding: 'clamp(20px,4vw,32px)', border: '1px solid #dbe8eb', borderRadius: 24, background: '#ffffff', boxSizing: 'border-box', boxShadow: '0 10px 30px rgba(8,145,178,.04)' },
  ...
  partnerCard: { display: 'flex', flexDirection: 'column', minHeight: 290, padding: 20, border: '1px solid #dbe8eb', borderRadius: 20, background: '#ffffff', boxSizing: 'border-box', boxShadow: '0 10px 30px rgba(8,145,178,.05)' },
  ...
  card: { maxWidth: 1120, margin: '18px auto', padding: 'clamp(18px,4vw,30px)', border: '1px solid #dbe8eb', borderRadius: 24, background: '#ffffff', boxSizing: 'border-box', boxShadow: '0 10px 30px rgba(8,145,178,.04)' },
