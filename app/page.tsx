  ...
  return (
    <div className={`top-ticker-lux ${mounted ? 'visible' : ''}`}>
      ...
      <style jsx>{`
        ...
        .ticker-inner { display: flex; align-items: center; gap: 30px; font-size: 9px; letter-spacing: 1px; font-weight: 700; color: #1d1d1f; }
...
export default function Home() {
  ...
  return (
    <div className="az-premium-canvas">
      ...
      <style jsx global>{`
        html, body { background-color: #f0f9fa !important; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "SF Pro Display", sans-serif; scroll-behavior: smooth; }
        .az-premium-canvas { background-color: #f0f9fa; min-height: 100vh; color: #1d1d1f; overflow-x: hidden; }
        ...
        .nav-minimal-lux { 
          ...
          padding: 60px 60px 20px; max-width: 1400px; margin: 0 auto; position: relative; z-index: 10; 
        }
        ...
        .network-signal { display: flex; align-items: center; gap: 8px; color: #0891b2; font-size: 8px; font-weight: 800; letter-spacing: 1px; }
        .sig-dot { width: 4px; height: 4px; background: #22d3ee; border-radius: 50%; animation: blink 1.5s infinite; }
        @keyframes blink { 0%, 100% { opacity: 1; } 50% { opacity: 0.3; } }
        .btn-cyan-outline { background: none; border: 1px solid #22d3ee; color: #0891b2; padding: 8px 20px; border-radius: 100px; cursor: pointer; font-weight: 800; font-size: 10px; transition: 0.3s; }
        .btn-cyan-outline:hover { background: #22d3ee; color: #fff; transform: translateY(-1px); box-shadow: 0 4px 12px rgba(34, 211, 238, 0.2); }

        .hero-apple-style { 
          padding: 100px 20px 40px; text-align: center; display: flex; flex-direction: column; align-items: center;
        }
        ...
        .hero-title { font-size: clamp(40px, 8vw, 85px); font-weight: 900; line-height: 0.95; letter-spacing: -0.05em; margin: 0; }
        .cyan-glitch { color: #22d3ee; text-shadow: 0 0 30px rgba(34, 211, 238, 0.2); }
        .hero-desc { font-size: clamp(16px, 2vw, 19px); color: #5c5e62; margin: 30px 0; font-weight: 500; max-width: 700px; line-height: 1.5; }
        ...
        /* MODIFICATA: Grande Barra Orizzontale Lux - Colore Bianco Panna Leggero + Effetto Cyber Radar */
        .live-stream-ticker {
        ...
        /* AGGIUNTO: Effetto Cyber Scanner "WOW" in sottofondo */
        ...
        /* MODIFICATA: Interazione WOW Micro-Magnetica sui singoli nodi della barra */
        .marquee-item { 
        ...
        /* MODIFICATA: Animazione e stile delle thumbnail nella barra */
        .ticker-thumb { 
        ...
        .about-visual { flex: 1; position: relative; overflow: hidden; border-radius: 24px; }
        .about-image { 
          width: 100%; border-radius: 24px; border: 4px solid #1d1d1f;
          box-shadow: 20px 20px 0px #22d3ee; transition: 0.5s cubic-bezier(0.2, 0.8, 0.2, 1);
        }
        ...
        .quad-card-premium { 
          ...
          display: flex; flex-direction: column; justify-content: space-between; min-height: 280px; position: relative; overflow: hidden;
        }
        ...
        .auth-footer-lux { margin: 80px 0 50px; display: flex; flex-direction: column; align-items: center; gap: 30px; }
        .staff-box-lux { 
          background: white; border: 4px solid #1d1d1f; 
          padding: 25px; border-radius: 20px; width: 340px; box-shadow: 0 10px 30px rgba(0,0,0,0.05);
          transition: 0.3s;
        }
        ...
        .auth-container input { flex: 1; border: 1px solid #e5e7eb; padding: 10px; border-radius: 8px; font-family: monospace; font-size: 12px; outline: none; background: #f9fafb; transition: 0.3s; }
        ...
        .auth-container button { 
          ...
          font-size: 9px; font-weight: 900; cursor: pointer; transition: 0.3s;
        }
        ...
        @media (max-width: 900px) {
          ...
          .blueprint-grid { grid-template-columns: 1fr; gap: 15px; }
          .about-section { flex-direction: column !important; text-align: center; }
          .about-image { box-shadow: 10px 10px 0px #22d3ee; }
          .nav-minimal-lux { padding: 40px 20px; }
          .monitor-grid-apple { gap: 20px; padding: 20px; flex-wrap: wrap; justify-content: center; }
        }
      `}</style>
